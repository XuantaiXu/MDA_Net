...
dir_checkpoint = "/mnt/data/xxt/chapter2/3D_unet_GAN/dataset/adam_model_64_64_32_GAN"
...
def train_net(model, epochs, mantage1,mantage2,mantage3, foreground_label1, background_label1,foreground_label2 ,background_label2,foreground_label3 ,background_label3):
    ...
    scheduler1 = lr_scheduler.MultiStepLR(optimizer1, milestones=[3,19], gamma=0.1)
 #
    #
    scheduler2 = lr_scheduler.MultiStepLR(optimizer2, milestones=[3,19], gamma=0.1)
    scheduler3 = lr_scheduler.MultiStepLR(optimizer3, milestones=[3,19], gamma=0.1)
    ...
    for epoch in range(epochs):
      ...
      #  random.shuffle(val_list)
        ...
        f = open(r'train_processing\646432_unet3D_val1.txt', 'a')
        print(s, file=f)
        f.close()
...
if __name__ == '__main__':
    #  源域
    mantage_path1 = train_path + '/' + 'newdata' + '/' + 'mont'
    foreground_label_path1 = train_path + '/' + 'newdata' + '/' + 'label'
    background_label_path1 = train_path + '/' + 'newdata' + '/' + 'back128'
    #  目标域
    mantage_path2 = train_path + '/' + 'source' + '/' + 'mont'
    foreground_label_path2 = train_path + '/' + 'source' + '/' + 'label'
    background_label_path2 = train_path + '/' + 'source' + '/' + 'back128'

    #验证集adam_model_64_64_32_GAN2adam_model_64_64_32_GAN2
    mantage_path3 = train_path + '/' + 'source' + '/' + 'mont'
    foreground_label_path3 = train_path + '/' + 'source' + '/' + 'label'
    background_label_path3 = train_path + '/' + 'source' + '/' + 'back128'
